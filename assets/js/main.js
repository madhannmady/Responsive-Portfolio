/*==================== MENU SHOW Y HIDDEN ====skillsHeader.forEach((el) => {
  el.addEventListener("click", toggleSkills);
});

/*==================== QUALIFICATION TOGGLE ====================*/
const qualificationCheckbox = document.getElementById(
...
const educationIcon = document.getElementById("toggle-education-icon");
const experienceIcon = document.getElementById("toggle-experience-icon");

// This function updates the view based on the toggle's state
function handleQualificationToggle() {
  if (qualificationCheckbox.checked) {
    // If checked, show Experience
    ...
    educationIcon.classList.remove("active");
    experienceIcon.classList.add("active");
  } else {
    // If not checked, show Education
    ...
    experienceIcon.classList.remove("active");
    educationIcon.classList.add("active");
  }
}

// Add listeners to the checkbox and icons
qualificationCheckbox.addEventListener("change", handleQualificationToggle);

educationIcon.addEventListener("click", () => {
  qualificationCheckbox.checked = false;
  handleQualificationToggle(); // Manually trigger the update
});
...
// Set the initial view to 'Education' when the page loads
educationIcon.classList.add("active");
